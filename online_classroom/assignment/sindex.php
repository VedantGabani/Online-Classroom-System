...
<body class="body-style">
        ...
        <div class="container-fluid"><a class="navbar-brand" href="../index.html">CO INTRA</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav mx-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="../attendance/sindex.php">View Attendance</a></li>
                </ul>
    ...
    <section id="main-content" class="w-100 h-100">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <a>Your annoucement:</a>
                    <ul class="list-group">
                        <?php
                        $query = "SELECT * FROM assignment_master WHERE class_id = (SELECT class_id FROM student_master WHERE enroll = " . $_SESSION['login_user'] . ");";
                        $queryResult = $con->query($query);
                        foreach ($queryResult as $row) {
                            echo '<li class="list-group-item">' . $row['details'] . '</li>';
                        }
                        ?>
                    </ul>
                </div>
