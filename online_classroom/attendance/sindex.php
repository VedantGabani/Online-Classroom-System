        ...
        <div class="container-fluid"><a class="navbar-brand" href="../index.html">CO INTRA</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav mx-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="../assignment/sindex.php">Check Announcement</a></li>
                </ul>
                ...
                <div class="col-auto">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <?php
                                $query = "SELECT hours FROM student_master WHERE enroll = " . $_SESSION['login_user'] . ";";
                                ...
                                $query = "SELECT hours FROM class_master WHERE id = (SELECT class_id FROM student_master WHERE enroll = " . $_SESSION['login_user'] . ");";
                                $queryResult = $con->query($query);
                                $totalHours = "";
                                // print_r($queryResult);
                                foreach ($queryResult as $row) {
                                ...
                                echo "Percentage: ", round((((int)$hour) * 100) / (int)$totalHours), "%";
