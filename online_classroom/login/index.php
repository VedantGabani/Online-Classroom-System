...
<body class="body-style">
    ...
    <section id="main-content" class="w-100 h-100">
        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center" style="margin: 0px">
                <a class="link" href="studentlogin.php"><button type="button" class="btn btn-primary">Student Login</button></a>
            </div><br>

            <div class="row d-flex justify-content-center align-items-center" style="margin: 0px">
                <a class="link" href="facultylogin.php"><button type="button" class="btn btn-primary">Faculty Login</button></a>
            </div>
        </div>
        </div>
        </div>
